...
function TendersPage({ onNavigate }: TendersPageProps) {
    ...
    return (
        <>
            <Helmet>
                <title>Tender Notices | Zeba Enterprises – Contracting & Infrastructure Bids</title>
                <meta name="description" content="Browse tender notices and bidding opportunities from Zeba Enterprises for contracting, infrastructure development, civil engineering, and project execution work." />
                <link rel="canonical" href="https://www.zebaenterprises.com/tender" />
                <meta property="og:title" content="Tender Notices – Zeba Enterprises" />
                <meta property="og:description" content="Latest contracting and engineering tender invitations from Zeba Enterprises." />
                <meta property="og:url" content="https://www.zebaenterprises.com/tender" />
