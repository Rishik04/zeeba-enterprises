...
export function AboutPage({ onNavigate }: AboutPageProps) {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | Zeba Enterprises – Engineering, Contracting & Infrastructure Experts</title>
        <meta name="description" content="Learn about Zeba Enterprises, a trusted Indian company delivering contracting, engineering, consulting, logistics, and maintenance services with a commitment to quality, precision, and social responsibility." />
        <link rel="canonical" href="https://www.zebaenterprises.com/about" />
        <meta property="og:title" content="About Zeba Enterprises" />
        <meta property="og:description" content="Reliable partner for multi-sector engineering, infrastructure, and contracting services across India." />
        <meta property="og:url" content="https://www.zebaenterprises.com/about" />
