...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  return (
    <>
      <Helmet>
        <title>Zeba Enterprises | Contracting, Engineering & Infrastructure Company in India</title>
        <meta name="description" content="Zeba Enterprises is a leading Indian company specializing in contracting, engineering, consulting, logistics, pump works, and infrastructure projects with a strong focus on quality, precision, and sustainable development." />
        <link rel="canonical" href="https://www.zebaenterprises.com/" />
        <meta property="og:title" content="Zeba Enterprises | Contracting, Engineering & Infrastructure Company" />
        <meta property="og:description" content="Trusted partner for railway, mining, roadways, pipelines, construction, consulting, logistics, and pump engineering services across India." />
        <meta property="og:url" content="https://www.zebaenterprises.com" />
