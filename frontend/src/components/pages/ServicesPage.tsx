...
export function ServicesPage({ onNavigate }: ServicesPageProps) {
  ...
  return (
    <>
      <Helmet>
        <title>Services | Zeba Enterprises – Contracting, Civil Engineering, Logistics, Pump Works & Consulting</title>
        <meta name="description" content="Explore Zeba Enterprises' services including contracting works, railway & mining projects, road & highway construction, logistics solutions, civil engineering, pump engineering, and business consulting." />
        <link rel="canonical" href="https://www.zebaenterprises.com/services" />
        <meta property="og:title" content="Our Services – Zeba Enterprises" />
        <meta property="og:description" content="From contracting and civil engineering to logistics, pump works, and consulting—Zeba Enterprises delivers solutions with excellence." />
        <meta property="og:url" content="https://www.zebaenterprises.com/services" />
